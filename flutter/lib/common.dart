...
class MyTheme {
  ...
  static const Color grayBg = Brand.grayBg;
  static const Color accent = Brand.accent;
  static const Color accent50 = Brand.accent50;
  static const Color accent80 = Brand.accent80;
  static const Color canvasColor = Brand.canvasColor;
  static const Color border = Brand.border;
  static const Color idColor = Brand.idColor;
  static const Color darkGray = Brand.darkGray;
  static const Color cmIdColor = Brand.cmIdColor;
  static const Color dark = Brand.dark;
  static const Color button = Brand.button;
  static const Color hoverBorder = Brand.hoverBorder;
